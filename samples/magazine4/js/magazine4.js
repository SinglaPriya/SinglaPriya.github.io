...
(function($) {
	...
	var sampleName = 'magazine4',
		samplePath = 'samples/magazine4/';
	...
	function loadPage(page) {
		...
		var img = $('<img />');
		img.load(function() {
			var container = $('.magazine4 .p'+page);
			img.css({width: '100%', height: '100%'});
			img.appendTo($('.magazine4 .p'+page));
