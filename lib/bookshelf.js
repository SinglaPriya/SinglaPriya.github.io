    ...
    var test = [],
      ...
      loadNextTest = function() {
        ...
        if (sample.loading==status.loading) {
          ...
          // console.log("1 "+sample.path+" "+sample.callback+" "+sample.loading);
          console.trace("pre loading "+demoName);
          // console.log("2 "+sample.path+" "+sample.callback+" "+sample.loading);
          // console.log(sample)
          // console.log("4 "+sample.path+" "+sample.callback+" "+sample.loading);
          ...
          yepnope({
            ...
            complete: function() {
              // console.log("3 "+sample.path+" "+sample.callback+" "+sample.loading);
